  ...
  return (
    <main className="flex min-h-[100svh] items-center justify-center px-6">
      <div className="text-center">
        ...
        <h1 className="font-display mt-6 text-5xl text-[var(--text-primary)]">Off the chart.</h1>
        <p className="mt-4 text-[var(--text-muted)]">That page isn't part of the portfolio.</p>
        <Link
          href="/"
